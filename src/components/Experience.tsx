      ...
      <SectionReveal className="max-w-5xl mx-auto">
        ...
        <div className="mb-10 p-5 rounded-2xl frosted-glass-card bento-item border border-white/80 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-2xs">
          <div className="flex items-start gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-white border border-slate-200/90 flex items-center justify-center p-2 text-blue-600 shrink-0 shadow-2xs overflow-hidden">
              <img
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-blue-50 text-[10px] font-mono font-medium text-blue-700 border border-blue-200/60">
                  CAPACITI
                </span>
              </div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-5 pb-6 border-b border-slate-100/80">
                <div className="flex items-start gap-4 sm:gap-5">
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-white border border-slate-200/90 shadow-2xs flex items-center justify-center p-2.5 shrink-0 overflow-hidden group-hover/card:border-blue-300 transition-colors">
